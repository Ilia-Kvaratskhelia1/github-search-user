      ...
      <div className="childContainer">
        ...
        <div className="searchSection">
          <div className="inputsection">
            <input
              ...
              type="text"
            />
            <img className="loopIcon" src={loopIcon} />
            <p className="searchError">not result</p>
            <button onClick={props.handleSubmit} className="searchButton">
              Search
            </button>
          </div>
        </div>
        ...
        <div className="profileSection">
          ...
          <div className="personSide">
            <div className="personTextarea">
              <h1>
                {props.name}
                <p className="lightname">@{props.userName}</p>
              </h1>
